...
import trip from "../../../assets/tripk.png"
  ...
  return (
    <div className='py-8 flex w-full px-8 '>
        ...
        <div className='w-1/2 flex flex-col  space-y-6'>
            ...
            <button className='px-8 py-2 rounded-full border w-1/4'  style={{color: "rgba(0, 18, 77, 1)",borderColor:"rgba(0, 18, 77, 1)"}}>Learn more</button>
